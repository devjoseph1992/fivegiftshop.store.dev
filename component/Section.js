            ...
            <section className='bg-green-600'>
                <div className='flex justify-between px-4 py-3'>
                    <div className='relative'>
                        ...
                        <input className='bg-green-700 focus:outline-none focus:bg-white focus:text-gray-400 text-white rounded-lg pl-10 pr-3 py-2' placeholder='Search item'/>
                    </div>
                <button className='inline-flex bg-green-700 hover:bg-green-600 focus:outline-none focus:shadow-outline rounded-lg shadow pl-3 pr-4 items-center'
                    onClick={find}
                >
                    ...
                    <span className='ml-1 text-white font-meduim'>Search</span>
                </button>
                </div>
                <Filter/>
            </section>
